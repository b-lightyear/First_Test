...
public class CommonUtil {
	...
	public void fileDownload(HttpServletRequest request, HttpServletResponse response, String filename, String filepath) {
		...
		try {
			...
			filename =URLEncoder.encode(filename, "utf-8"); //한글 변환
	...
	private void sendHtmlEmail(String email, String name, HttpServletRequest request) {
		...
		try {
			...
			msg.append(
					"<a href='http://naver.com'><img src='https://mimgnews.pstatic.net/image/upload/office_logo/003/2019/01/23/logo_003_6_20190123191323.jpg'></a>");
			msg.append("<hr>");
			...
			file.setPath(request.getServletContext().getRealPath("files") + "/회원가입축하메시지.txt");
			mail.attach(file);
